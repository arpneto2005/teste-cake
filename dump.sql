...
CREATE DATABASE IF NOT EXISTS `aula_cakephp` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `aula_cakephp`;
...
-- Copiando dados para a tabela aula_cakephp.categories: ~8 rows (aproximadamente)
...
-- Copiando dados para a tabela aula_cakephp.customers: ~91 rows (aproximadamente)
...
-- Copiando dados para a tabela aula_cakephp.employees: ~10 rows (aproximadamente)
...
-- Copiando dados para a tabela aula_cakephp.orderdetails: ~518 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  KEY `FK_orders_shippers` (`ShipperID`),
...
-- Copiando dados para a tabela aula_cakephp.orders: ~196 rows (aproximadamente)
...
-- Copiando dados para a tabela aula_cakephp.products: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela aula_cakephp.shippers: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela aula_cakephp.suppliers: ~29 rows (aproximadamente)
